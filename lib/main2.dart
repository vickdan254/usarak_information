...
import 'package:usarak_information/other_page.dart';
                ...
                children: <Widget>[
                  ListTile(
                    ...
                    leading: Icon(Icons.question_answer,
                        size: 32.0, color: Colors.blue.shade400),
                    trailing: Icon(Icons.menu),
                    //    onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: BuildContext context) => OtherPage(pageText)),
                  ...
                  ListTile(
                    ...
                    trailing: Icon(Icons.cancel,
                        size: 35.0, color: Colors.grey.shade400),
                  ),
                ],
              ),
            ],
